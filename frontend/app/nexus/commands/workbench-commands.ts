...
export function registerWorkbenchCommands() {
    ...
    const commands: CommandDefinition[] = [
        ...
        { id: "module.openJarvis", title: "Abrir Jarvis", description: "Abrir el módulo Jarvis", category: "Navegación y módulos", defaultShortcut: "Ctrl+Alt+J", contexts: ["global"], editable: true, handler: unavailable("Jarvis") },
