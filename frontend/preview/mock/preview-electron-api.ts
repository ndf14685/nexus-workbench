...
const previewElectronApi: ElectronApi = {
    ...
    listSitePermissions: () => Promise.resolve([]),
    setSitePermission: (_record) => Promise.resolve([]),
    revokeSitePermission: (_origin, _permission) => Promise.resolve([]),
    revokeAllSitePermissions: (_permission) => Promise.resolve([]),
    ensureWebSession: (_partition: string) => {},
