...
contextBridge.exposeInMainWorld("api", {
    ...
    listSitePermissions: () => ipcRenderer.invoke("nexus-permissions-list"),
    setSitePermission: (record) => ipcRenderer.invoke("nexus-permissions-set", record),
    revokeSitePermission: (origin, permission) => ipcRenderer.invoke("nexus-permissions-revoke", origin, permission),
    revokeAllSitePermissions: (permission) => ipcRenderer.invoke("nexus-permissions-revoke-all", permission),
    ensureWebSession: (partition: string) => ipcRenderer.send("ensure-web-session", partition),
